...
const PregledPage = () => {
    ...
    const fetchPorudzbine = async () => {
        ...
        try {
            const response = await fetch(`https://www.naruci.co.rs/api/v1/porudzbina/get/user/${decodedToken.id}/date-range?startDate=${formattedStartDate}&endDate=${formattedEndDate}`, {
                method: "GET",
                headers: {
