...
const AdminKompanije = () => {
    ...
    const toggleCompStatus = async () => {
        ...
        try {
            await fetch(`https://narucivanje-back.naruci.co.rs:8443/api/v1/kompanija/update/${selectedComp.id}`, {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${token}`
    ...
    const handleSave = async () => {
        ...
        const url = editMode
            ? `https://narucivanje-back.naruci.co.rs:8443/api/v1/kompanija/update/${selectedComp.id}`
            : "https://narucivanje-back.naruci.co.rs:8443/api/v1/kompanija/create";
