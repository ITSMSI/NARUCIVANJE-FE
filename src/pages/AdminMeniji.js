...
const AdminMeniji = () => {
    ...
    const fetchMeni = async () => {
        ...
        try {
            ...
            const response = await fetch(`https://naruci.co.rs/api/v1/meni/get/date-range?startDate=${formattedStartDate}&endDate=${formattedEndDate}`, {
                method: "GET",
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            let url = editMode
                ? `https://naruci.co.rs/api/v1/meni/update/${meniId}`
                : "https://naruci.co.rs/api/v1/meni/create";
            ...
            const obrokUrl = `https://naruci.co.rs/api/v1/meni/${meniId}/add-obroks`;
    ...
    const handleRemoveObrok = async (obrok) => {
        ...
        try {
            const response = await fetch(`https://naruci.co.rs/api/v1/meni/${selectedMeni.id}/remove-obrok/${obrok.id}`, {
                method: "DELETE",
                headers: {
                    "Authorization": `Bearer ${token}`
                }
    ...
    const toggleMeniStatus = async () => {
        ...
        try {
            await fetch(`https://naruci.co.rs/api/v1/meni/update/${selectedMeni.id}`, {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${token}`
